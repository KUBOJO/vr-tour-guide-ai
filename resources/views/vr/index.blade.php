            ...
            <div>
                ...
                <div class="glass rounded-3xl p-5 shadow-2xl">
                    ...
                    @if(isset($locations) && $locations->count() > 0)
                        ...
                        <img src="{{ url('/get-locations-image/' . basename($locations->first()?->image_path)) }}" 
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            @foreach($locations as $location)
                ...
                <div class="glass rounded-3xl overflow-hidden card-hover shadow-xl">
                    ...
                    <a href="/vr-location/{{ $location->id }}">

                        <div class="relative">

                            <img src="{{ url('/get-locations-image/' . basename($location->image_path)) }}"
                    ...
                    <div class="p-5">
                        ...
                        <div class="mt-6 space-y-3">
                            ...
                            <button
                                id="btn-mic-{{ $location->id }}"
                                onclick="startRecording(event, {{ $location->id }})"
                            ...
                            <div id="response-{{ $location->id }}"
                                ...
                                <div>
                                    ...
                                    <p id="question-text-{{ $location->id }}"></p>
                                </div>
                                ...
                                <div>
                                    ...
                                    <p id="answer-text-{{ $location->id }}"></p>
                                </div>

                                <audio
                                    id="audio-player-{{ $location->id }}"
                                    controls
                                    class="w-full mt-3">
                                </audio>
                    ...
                    <div class="space-y-4">
                        ...
                        @if($query->audio_path)
                            ...
                            <audio controls class="w-full mt-3">
                                <source src="{{ $query->audio_path }}" type="audio/mpeg">
